...
/**
 * Class that represent ID3tagV1.1
 * @author antho
 */

public class tagv1_1 extends ID3tagV1{

	private String num;	//number of the track
	...
	public boolean readTag(File file) {
		if (file.exists()){
			...
			try {
				...
				if(f.read() == 0)
					this.num = String.valueOf(f.read());
				else this.num = "0";

				//read genre of the track
				f.readFully(genre);
				super.genre = ((int)genre[0] < super.TAB_GENRE.length && (int)genre[0] >= 0) ? super.TAB_GENRE[(int)genre[0]] : super.TAB_GENRE[super.TAB_GENRE.length-1];
...
//				return true;
	...
	public boolean writeTag(File file) {
		if (file.exists()){
			...
			try {
				...
				//write track name
				StringBuffer track = (super.track != null) ? new StringBuffer(super.track) : new StringBuffer();
				track.setLength(30);
				f.writeBytes(track.toString());
				
				//write artist
				StringBuffer artist = (super.artist != null) ? new StringBuffer(super.artist) : new StringBuffer();
				artist.setLength(30);
				f.writeBytes(artist.toString());
				
				//write album 
				StringBuffer album = (super.album != null) ? new StringBuffer(super.album) : new StringBuffer();
				album.setLength(30);
				f.writeBytes (album.toString());
				
				//write year
				StringBuffer year = (super.year != null) ? new StringBuffer(super.year) : new StringBuffer();
				year.setLength(4);
				f.writeBytes (year.toString());
				
				//write comment
				StringBuffer comment = (super.comment != null) ? new StringBuffer(super.comment) : new StringBuffer();
				comment.setLength(28);
				f.writeBytes(comment.toString());
				
				//write number
				f.writeByte(0);
				f.writeByte(Integer.valueOf(this.num));
	 ...
	 */
	@Override
	public String getAlbum() {return super.album;}

	/*
	 * @see com.music.model.tag.Tag#getArtist()
	 */
	@Override
	public String getArtist() {return super.artist;}
	 ...
	 */
	@Override
	public String getGenre() {return super.genre;}
	 ...
	 */
	@Override
	public String getTrack() {return super.track;}

	/*
	 * @see com.music.model.tag.Tag#getYear()
	 */
	@Override
	public String getYear() { return super.year;}

	/*
	 * @see com.music.model.tag.Tag#setAlbum(java.lang.String)
	 */
	@Override
	public void setAlbum(String album) {super.album = album;}

	/*
	 * @see com.music.model.tag.Tag#setArtist(java.lang.String)
	 */
	@Override
	public void setArtist(String artist) {super.artist = artist;}

	/*
	 * @see com.music.model.tag.Tag#setComment(java.lang.String)
	 */
	@Override
	public void setComment(String comment) {super.comment = comment;}

	/*
	 * @see com.music.model.tag.Tag#setGenre(java.lang.String)
	 */
	@Override
	public void setGenre(String genre) {super.genre = genre;}
	 ...
	 */
	@Override
	public void setTrack(String track) {super.track = track;}

	/*
	 * @see com.music.model.tag.Tag#setYear(java.lang.String)
	 */
	@Override
	public void setYear(String year) {super.year = year;}
}
